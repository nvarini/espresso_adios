MODULE adios_pw
 ...
 CONTAINS
 !write the evc on the specified filename
 !adios_open open the group_name specified in the pwdesc.xml, see Modules/adios_qe.f90
 !include "gwrite_wfc.fh" open a file, generated by gpp.py pwdesc.xml, that contains what needs to be written
 !adios_close write the files on disk 
